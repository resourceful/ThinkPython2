...
\index{encapsulation} 연습 문제로 이 코드를 {\tt count}라는 함수
...
호출(invoke)했다.
% 재번역 A method call is called an {\bf invocation}; in this case, we would
...
% 원문 Keep that in mind in case you have to defend yourself against a man armed with a Pineapple.
